...
## Make panel with 4 plots
par(mfrow=c(2, 2))
##top left Global active power 
plot(as.POSIXct(data$DateTime, "year-mday-mon hour:min:sec UTZ"), data$Global_active_power, type = "l", 
     xlab = "", ylab="Global Active Power")
## top right Voltage
plot(as.POSIXct(data$DateTime, "year-mday-mon hour:min:sec UTZ"), data$Voltage, type = "l", 
...
plot(as.POSIXct(data$DateTime, "year-mday-mon hour:min:sec UTZ"), data$Global_reactive_power, type = "l", 
